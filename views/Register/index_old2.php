...
<body translate="no">
  <div class="login-wrap">
	...
	<label class="tab">Proyecto Sahueso Prexxa</label>
	<div class="hr"></div>
    ...
    <?php if(!empty($datosVista) && $datosVista != 'Usuario y/o contraseña incorrecto!'){
		...
		<div class="login-form">
			...
			<form class="form-valide-register" action="?url=Register/RegistrarUsuario" method="post">
			  <div class="form-group">
              <label for="val-username" class="label">Nombre</label>
            <div>
